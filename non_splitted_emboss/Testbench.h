...
public:
	...
	cynw_p2p< sc_dt::sc_uint<8> >::base_in i_result1;
  cynw_p2p< sc_dt::sc_uint<8> >::base_in i_result2;
  cynw_p2p< sc_dt::sc_uint<8> >::base_in i_result3;
#else
	sc_fifo_out< sc_dt::sc_uint<24> > o_rgb;
	sc_fifo_in< sc_dt::sc_uint<8> > i_result1;
  sc_fifo_in< sc_dt::sc_uint<8> > i_result2;
  sc_fifo_in< sc_dt::sc_uint<8> > i_result3;
#endif
