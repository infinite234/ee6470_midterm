...
private:
  Testbench tb;
	...
	cynw_p2p< sc_dt::sc_uint<8> > result1;
  cynw_p2p< sc_dt::sc_uint<8> > result2;
  cynw_p2p< sc_dt::sc_uint<8> > result3;
#else
	sc_fifo< sc_dt::sc_uint<24> > rgb;
	sc_fifo< sc_dt::sc_uint<8> > result1;
  sc_fifo< sc_dt::sc_uint<8> > result2;
  sc_fifo< sc_dt::sc_uint<8> > result3;
